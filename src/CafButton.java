...
/**
 * Classe que controla o JButton e para gerar o TButton
...
public class CafButton extends JButton {
	...
	private static final long serialVersionUID = 1607682026191065699L;
	
	/** Construtor da classe
     * @param titulo String contendo o "text" para o CafButton
     * @param recModi Janela principal
     */    
    public CafButton(String titulo, PDialogMaker recModi) {
        frmModi = recModi;
        this.setText(titulo);
        selected = false;
        resizing = true;
