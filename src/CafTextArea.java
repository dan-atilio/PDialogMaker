...
/**
 * Classe que controla o JTextArea e para gerar o TMultiGet
...
public class CafTextArea extends JTextArea {
	...
	private static final long serialVersionUID = -6354574601795324581L;
	/** Construtor da classe
     * @param titulo String contendo o "text" para o CafTextArea
     * @param recModi Janela principal
     */
    public CafTextArea(String titulo, PDialogMaker recModi) {
        frmModi = recModi;
        this.setText(titulo);
        selected = false;
        resizing = true;
