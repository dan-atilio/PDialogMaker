...
/**
 * Classe que controla o JCheckBox e para gerar o TCheckBox
...
public class CafCheckBox extends JCheckBox {
	...
	private static final long serialVersionUID = -7768940223524510345L;
	
	/** Construtor da classe
     * @param titulo String contendo o "text" para o CafCheckBox
     * @param recModi Janela principal
     */
    public CafCheckBox(String titulo, PDialogMaker recModi) {
        frmModi = recModi;
        this.setText(titulo);
        selected = false;
        resizing = true;
