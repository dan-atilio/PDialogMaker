...
/**
 * Classe que controla o JPasswordField, mas ela não é usada no PDialogMaker, então o fonte foi mantido apenas por compatibilidade
...
public class CafPasswordField extends JPasswordField {
	...
	private static final long serialVersionUID = 100529835043325418L;
	/** Construtor da classe
     * @param titulo String contendo o "text" para o CafPasswordField
     * @param recModi Janela principal
     */
    public CafPasswordField(String titulo, PDialogMaker recModi) {
        frmModi = recModi;
        this.setText(titulo);
        selected = false;
        resizing = true;
