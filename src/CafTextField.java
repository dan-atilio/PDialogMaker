...
/**
 * Classe que controla o JTextField e para gerar o TGet
...
public class CafTextField extends JTextField {
	...
	private static final long serialVersionUID = -8275082494403296133L;
	/** Construtor da classe
     * @param titulo String contendo o "text" para o CafTextField
     * @param recModi Janela principal
     */
    public CafTextField(String titulo, PDialogMaker recModi) {
        frmModi = recModi;
        this.setText(titulo);
        selected = false;
        resizing = true;
