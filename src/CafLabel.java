...
/**
 * Classe que controla o JLabel e para gerar o TLabel
...
public class CafLabel extends JLabel {
	...
	private static final long serialVersionUID = 6795902068989345632L;
	/** Construtor da classe
     * @param titulo String contendo o "text" para o CafLabel
     * @param recModi Janela principal
     */
    public CafLabel(String titulo, PDialogMaker recModi) {
        frmModi = recModi;
        this.setText(titulo);
        selected = false;
        resizing = true;
