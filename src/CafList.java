...
/**
 * Classe que controla o JList e para gerar o TListBox
...
public class CafList extends JList {

	private static final long serialVersionUID = -5315522411540186319L;
	/** Construtor da classe
     * @param recModi Janela principal
     */
    public CafList(PDialogMaker recModi) {
        frmModi = recModi;
        selected = false;
        resizing = true;
        selectRec = 6;
